...
def main():
    ...
    print("FULTON (GA) & KING (WA) SEVERE OUTAGE CLASSIFICATION")
    ...
    # Includes median-based balanced thresholds and industry standards
    test_thresholds = [
        0.0001,  # 0.01%
        0.00015,  # 0.015% (King median)
        0.0002,  # 0.02% (Fulton median)
        0.0003,  # 0.03%
        0.0005,  # 0.05%
        0.001,  # 0.1% (searched google for an industry standard)
        0.005,  # 0.5%
        0.01,  # 1% (common definition)
    ]
    all_results = {}
    ...
    with open(results_dir / "fulton_king_severe_summary.json", "w") as f:
